...
teammembers = [['Adrian', 'Cuadros'],['Elias', 'Matheus'],['Chelo', 'Gomez'],['Samuel','Heaney'],['Juan Miguel', 'Rubio'],['Oscar', 'Cisneros'],['Omar', 'Garza'],['Sebas', 'Gutierrez'],['Angel', 'Huerta'],['Emmanuel', 'Serna']]
